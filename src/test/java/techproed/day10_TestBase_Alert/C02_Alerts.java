...
public class C02_Alerts extends TestBase {
    ...
    public void acceptAlert() {
        ...
        driver.switchTo().//geçmek için kullanılan method
                ...
                accept();//çıkan alert'e ok yada tamam butonuna tıklar
        WebElement resultMessage = driver.findElement(By.xpath("(//p)[2]"));
        String istenenYazı = "You successfully clicked an alert";
        Assert.assertEquals(istenenYazı,resultMessage.getText());
    }
