...
public class C03_Alerts extends TestBase {
    ...
    public void test01() {
        ...
        System.out.println( "Allert üzerindeki Yazı :" +getTextAlert());
    ...
    public void test02() {
        ...
        String sonuçYazısı = driver.findElement(By.id("confirmResult")).getText();
        Assert.assertEquals("You selected Cancel",sonuçYazısı);
    }
    ...
    public void test03() {
        ...
        String sonuçYazısı = driver.findElement(By.id("promptResult")).getText();
        Assert.assertTrue(sonuçYazısı.contains("Erol"));
    }
}
