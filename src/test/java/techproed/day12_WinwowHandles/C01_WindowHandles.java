package techproed.day12_WinwowHandles;
...
public class C01_WindowHandles extends TestBase {
    ...
    //  ilk sayfasının Handle degerini alın yazdırın
       ...
       String expectedText = "Opening a new window";
        ...
        driver.findElement(By.xpath("(//a)[2]")).click(); //-->Kontrolüm dışında yeni bir sekme açıldı
        bekle(3);
        ...
        System.out.println("ikinciSayfaHandle Değeri = " + ikinciSayfaHandle);
    ...
    public void test02() {
       ...
       /*
       getWindowHandles() methodunu kullanarak açılan tüm pencerelerin handle değerlerimi bir arraylis'e atadık.
       Index 0(sıfır)'dan başladığı için kontrolüm dışında açılan pencere 1.index de olduğundan
       driver.switchTo().window(pencereler.get(1)); ile yeni açılan pencereye geçiş yaptık
        */
