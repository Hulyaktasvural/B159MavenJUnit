...
public class C02_Dropdown {
    ...
    public void test01() {
        //1.Method:
        //            a. Yil,ay,gün dropdown menu'leri locate ediniz
        WebElement yıl = driver.findElement(By.xpath("(//select)[2]"));
    ...
    public void test03() {
        ...
        WebElement eyaletler = driver.findElement(By.xpath("(//select)[5]"));
        Select select = new Select(eyaletler);
        String seçiliOlanSeçenek = select.getFirstSelectedOption().getText();
        System.out.println(seçiliOlanSeçenek);
        Assert.assertEquals("Select a State",seçiliOlanSeçenek);
       // Assert.assertTrue((seçiliOlanSeçenek.contains("Select")));
