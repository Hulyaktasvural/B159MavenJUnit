...
public class C03_KeyDownKeyUp extends TestBase {
    ...
    public void test01() {
        ...
        actions.keyDown(aramaKutusu, Keys.SHIFT). //-->Arama Kutusunda shift tuşuna bastık
                 sendKeys("selenium"). //-->selenium metninin shift tuşuna basılı kaldığı için büyük yazdı
    ...
    public void test02() {
        ...
        hatta bir den fazla klavye tuşlarına bastırabiliriz. Yukardaki örnekte sendKeys() methodu ile Keys.SHIFT diyerek
