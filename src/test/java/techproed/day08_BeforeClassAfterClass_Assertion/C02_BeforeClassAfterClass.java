...
public class C02_BeforeClassAfterClass {
    ...
    koyarız. Mesela testlerimiz başlamadan önce database bağlantısı yapmak için kullanılabilir ya da hangi driver'i 
    ...
    public void test01() throws InterruptedException {
        driver.findElement(By.xpath("//*[@class='eicon-close']")).click(); //çıkan reklamı kapatmak için
        Thread.sleep(2000);
