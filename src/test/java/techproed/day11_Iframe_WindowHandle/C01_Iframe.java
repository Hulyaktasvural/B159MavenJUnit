...
public class C01_Iframe extends TestBase {
    ...
    public void iframe() {
        ...
        driver.switchTo().frame(0); //--> geçiş yapmazsan Nosuchelement exception hatası alırız
        String ApplicationsListYazısı = driver.findElement(By.xpath("//h1")).getText();
        System.out.println(ApplicationsListYazısı);
        Assert.assertEquals("Applications lists",ApplicationsListYazısı);
