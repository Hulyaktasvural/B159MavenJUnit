...
public class C01_NoSuchElementException extends TestBase {
    ...
    public void test01() {
        ...
        //arama kutusunda "Full Stack Automation Engineer" aratalım
        WebElement aramaKutusu = driver.findElement(By.xpath("//*[@type='text']"));
        aramaKutusu.sendKeys("Full Stack Automation Engineer");
        driver.findElement(By.id("searchHeaderResult")).click();
        ...
        Assert.assertTrue(driver.getTitle().contains("Full Stack Automation Engineer"));
    }
    @Test
    public void test02() {
        //techproeducation sayfasına gidelim
