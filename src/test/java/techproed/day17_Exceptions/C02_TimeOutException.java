...
public class C02_TimeOutException extends TestBase {
    ...
    public void test02() {
        ...
        //Hello World! Yazının sitede oldugunu test et
        //WebElement helloWorldText =driver.findElement(By.xpath("yanlış locate")) ;

        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));
        wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("yanlış locate")));
        /*
        Yukarıdaki örnekte max. süreyi doğru vermemize rağmen yanlış locate aldığımız için yine
